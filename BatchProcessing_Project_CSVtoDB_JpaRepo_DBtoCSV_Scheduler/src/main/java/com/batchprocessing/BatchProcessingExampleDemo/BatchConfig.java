...
//	}
    ...
    public ItemWriter<Product> csvFileWriter() {
        ...
        writer.setResource(new FileSystemResource("updatedproducts.csv"));
...
//    @Bean
//    public Step stepA(ItemWriter<Product> reader, ItemProcessor<Product, Product> processor, ItemWriter<Product> writer){
